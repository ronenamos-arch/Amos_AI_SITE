                ...
                <GlassCard className="p-8 md:p-12">
                    ...
                    <div className="prose prose-invert max-w-none space-y-8 text-text-secondary leading-relaxed text-right" dir="rtl">
                        ...
                        <section>
                            ...
                            <p>
                                הגישה לתכני פרימיום, קורסים ומדריכים מותנית בתשלום כפי שמוגדר בדפי המוצר והמחירון. התשלום מבוצע באופן מאובטח באמצעות מערכת SmartBee (הכוללת סליקת מקס, כרטיסי אשראי ו-Bit בתקן PCI-DSS). חשבונית מס / קבלה דיגיטלית כדין מופקת ונשלחת לרוכש במייל אוטומטית. לאחר ביצוע התשלום, הגישה למשתמש נפתחת באופן אוטומטי.
                            </p>
                        </section>
