...
export const topicClusters: TopicCluster[] = [
...

  {
    ...
    tier: 'beginner',
    items: [
      item('guide', 'chatgpt-finance-guide-hebrew', 'ChatGPT לפיננסים: 20 מסגרות עבודה', 'intermediate', false, 30, '20 מסגרות פרומפטינג מובנות ל-FP&A ותקצוב'),
      item('resource', 'price-framework', 'מסגרת PRICE — ארטיפקטים עם Claude', 'intermediate', false, 20, 'מתודולוגיית PRICE ל-5 שלבי פרומפטינג'),
      item('blog', 'human-loop', 'הטריק ה-Human-in-the-Loop', 'intermediate', false, 8, 'מנגנוני בטיחות בפרומפטים פיננסיים'),
      ...
      item('prompt', 'exec-summary', 'Executive Summary for Boards', 'intermediate', false, 5, 'תרגול: סיכום מנהלים'),
      item('prompt', 'monte-carlo', 'Monte Carlo Risk Simulation', 'advanced', false, 5, 'סימולציית סיכונים מתקדמת'),
      item('prompt', 'revenue-forecast', 'Revenue Forecast Modeling', 'intermediate', false, 5, 'מודל חיזוי הכנסות'),
      item('resource', '102-prompt', '102 Prompts לאנשי כספים', 'intermediate', true, 45, 'הספרייה המלאה — 102 פרומפטים'),
      item('blog', 'ai-token-optimization-finance', 'איך לצמצם צריכת Tokens', 'intermediate', false, 8, 'חיסכון בעלויות וייעול פרומפטים'),
    ],
  },
  ...
  // ─── TIER 2: CORE SKILLS ──────────────────────────────────────────────
  {
    ...
    tier: 'intermediate',
    items: [
      item('guide', 'projects', 'Projects ב-AI: מכפיל הכוח', 'beginner', false, 15, 'הגדרת הקשר ארגוני ב-Claude Projects'),
      ...
      item('guide', 'live-artifacts-claude', 'Live Artifacts — המדריך המלא', 'intermediate', false, 20, 'יצירת ארטיפקטים אינטראקטיביים'),
      ...
      item('guide', 'claude-code-loop', 'אוטומציית /loop עם Claude Code', 'advanced', false, 15, 'עיבוד אצווה ולולאות אוטומטיות'),
      item('guide', 'claude-code-checkpoints', 'Claude Code Checkpoints', 'intermediate', false, 10, 'ניהול גרסאות ו-rollbacks'),
    ],
  },

  {
    ...
    tier: 'intermediate',
    items: [
      item('guide', 'excel-ai', 'Excel + AI — האנליסט החדש שלך', 'beginner', false, 15, 'שילוב Excel עם LLMs למידול נתונים'),
      item('blog', 'ai-excel', 'AI באקסל עושה את העבודה של אנליסט', 'beginner', false, 10, '4 שלבים לשדרוג Excel עם AI'),
      item('guide', 'copilot-cowork', 'Copilot Cowork — המדריך המעשי', 'beginner', false, 20, 'Copilot ליצירת מסמכים, לוחות שנה, ומיילים'),
      item('guide', 'copilot-skill', 'Copilot Skills — רואי חשבון עם AI', 'beginner', true, 15, 'אוטומציה של נוסחאות וניקוי נתונים'),
      item('guide', 'automation', '5 אוטומציות שכל צוות כספים צריך', 'beginner', false, 15, 'אוטומציות no-code חוסכות שעות'),
      item('guide', 'codex', 'Codex App — מ-0 ל-AI מלא ב-30 דקות', 'intermediate', false, 20, 'ניתוח Excel, PDF, CSV עם סוכנים'),
      ...
      item('guide', 'excel-to-zite-finance-crm-guide', 'Zite — מ-Excel לאפליקציית CRM', 'intermediate', false, 15, 'הפיכת גיליון לאפליקציה ללא קוד'),
    ],
  },
  ...
  // ─── TIER 3: MASTERY ──────────────────────────────────────────────────
  {
    ...
    tier: 'advanced',
    items: [
      item('blog', 'אימות-נתונים-לפני-הכל-אל-תתנו-ל-ai-לנתח-לפני-שווידאתם-ששורות', 'אימות נתונים לפני הכל', 'intermediate', false, 8, 'כלל #1: וולידציה לפני ניתוח'),
      item('prompt', 'reconciliation', 'Bank Reconciliation Matcher', 'intermediate', false, 5, 'התאמה בנקאית עם Fuzzy Logic'),
      item('prompt', 'journal-audit', 'Journal Entry Audit', 'advanced', false, 5, 'ביקורת פקודות יומן'),
      item('prompt', 'budget-variance', 'Budget Variance Report', 'intermediate', false, 5, 'דוח סטיות תקציב'),
      item('prompt', 'variance-commentary', 'Variance Commentary Writer', 'intermediate', false, 5, 'כתיבת הסברי סטיות לדירקטוריון'),
      item('resource', '50-ways-ai', '50 דרכים להשתמש ב-AI לסגירת חודש', 'intermediate', true, 45, '50 פרומפטים ב-8 קטגוריות סגירה'),
      item('blog', 'איך-לבצע-ניתוח-avb-תקציב-מול-ביצוע-ב-5-דקות-בלבד-בעזרת-claud', 'ניתוח AVB ב-5 דקות עם Claude', 'intermediate', false, 8, 'ניתוח Actual vs Budget מהיר'),
      item('blog', 'cash-flow-playground', 'Cash Flow Playground: מודל תרחישים', 'intermediate', false, 10, 'סימולציית תזרים דינמית'),
...

  {
    ...
    tier: 'advanced',
    items: [
      item('blog', 'ai-finance-dashboards-5-prompts', '5 דשבורדים חכמים שכל CFO צריך', 'intermediate', false, 10, '5 פרומפטים לדשבורדים HTML עצמאיים'),
      item('guide', 'ai-excel-dashboard', 'AI Dashboard Planning ב-Excel', 'beginner', true, 15, 'תכנון KPI ומבנה לפני שפותחים Excel'),
      item('resource', '12-shitot-avoda-dashboard-ai', '12 שיטות עבודה לדשבורדים עם Claude', 'intermediate', false, 30, 'מסגרת H·T·M·L לדשבורדים'),
      item('blog', 'claude-mobile-cfo-dashboard-decisions', 'מהטלפון לדשבורד חי: 3 שלבים', 'intermediate', false, 8, 'ארכיטקטורת דשבורד Mobile-First'),
      item('prompt', 'dashboard-summary', 'Financial Dashboard Summary', 'intermediate', false, 5, 'סינתוז נתונים לדשבורד'),
      item('prompt', 'kpi-analysis', 'KPI Performance Breakdown', 'intermediate', false, 5, 'פירוק KPI ו-drill-down'),
      item('blog', 'כך-תבנו-דאשבורד-cfo-אינטראקטיבי-תוך-דקות-בלי-it-ובלי-דליפת-נ', 'דשבורד CFO אינטראקטיבי תוך דקות', 'intermediate', false, 10, 'דשבורדים ללא IT עם Claude Artifacts'),
