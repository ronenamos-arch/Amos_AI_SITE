...
const faqs = [
    ...
    },
    {
        ...
        a: "₪100 לחודש, בסליקה מאובטחת דרך SmartBee (סליקת מקס, כרטיסי אשראי או Bit). חשבונית מס / קבלה דיגיטלית חתומה מופקת ונשלחת אליכם אוטומטית למייל בכל חודש.",
    },
    {
        q: "אפשר לבטל את המנוי?",
        a: "כן — ביטול בכל עת, ללא התחייבות ובלי שאלות. ניתן לפנות אלינו במייל או ב-WhatsApp והביטול מבוצע מיידית, כאשר הגישה לתוכן נשארת פתוחה עד סוף תקופת החיוב ששולמה.",
    },
    {
